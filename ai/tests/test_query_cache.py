...
def test_cache_key_deterministic():
    ...
    k1 = get_query_cache_key(1, "hello")
    k2 = get_query_cache_key(1, "hello")
    assert k1 == k2


def test_cache_key_session_isolated():
    """Different sessions get different keys."""
    k1 = get_query_cache_key(1, "hi")
    k2 = get_query_cache_key(2, "hi")
    assert k1 != k2
...
def test_cache_ttl_expiry():
    ...
    c = QueryCache(max_entries=10, ttl_seconds=0)
    key = get_query_cache_key(1, "q")
...
def test_cache_bounded_eviction():
    ...
    k1 = get_query_cache_key(1, "q1")
    k2 = get_query_cache_key(2, "q2")
    k3 = get_query_cache_key(3, "q3")
    ...
    # k1 was accessed via get() so moved to end. k2 is oldest → evicted.
